...
var openSignUpButton = document.getElementById("slide-left-button_1");
var openSignInButton = document.getElementById("slide-right-button_1");

// The sidebars
var leftText = document.getElementById("sign-in_1");
var rightText = document.getElementById("sign-up_1");

// The forms
var accountForm = document.getElementById("sign-in-info_1")
var signinForm = document.getElementById("sign-up-info_1");

// Open the Sign Up page
openSignUp = () =>{
  // Remove classes so that animations can restart on the next 'switch'
  leftText.classList.remove("overlay-text-left-animation-out_1");
  overlay.classList.remove("open-sign-in_1");
  rightText.classList.remove("overlay-text-right-animation_1");
  // Add classes for animations
  accountForm.className += " form-left-slide-out_1"
  rightText.className += " overlay-text-right-animation-out_1";
  overlay.className += " open-sign-up_1";
  leftText.className += " overlay-text-left-animation_1";
  // hide the sign up form once it is out of view
  setTimeout(function(){
    accountForm.classList.remove("form-left-slide-in_1");
    accountForm.style.display = "none";
    accountForm.classList.remove("form-left-slide-out_1");
  }, 700);
  // display the sign in form once the overlay begins moving right
  setTimeout(function(){
    signinForm.style.display = "flex";
    signinForm.classList += " form-right-slide-in_1";
  }, 200);
}
...
openSignIn = () =>{
  // Remove classes so that animations can restart on the next 'switch'
  leftText.classList.remove("overlay-text-left-animation_1");
  overlay.classList.remove("open-sign-up_1");
  rightText.classList.remove("overlay-text-right-animation-out_1");
  // Add classes for animations
  signinForm.classList += " form-right-slide-out_1";
  leftText.className += " overlay-text-left-animation-out_1";
  overlay.className += " open-sign-in_1";
  rightText.className += " overlay-text-right-animation_1";
  // hide the sign in form once it is out of view
  setTimeout(function(){
    signinForm.classList.remove("form-right-slide-in_1")
    signinForm.style.display = "none";
    signinForm.classList.remove("form-right-slide-out_1")
  },700);
  // display the sign up form once the overlay begins moving left
  setTimeout(function(){
    accountForm.style.display = "flex";
    accountForm.classList += " form-left-slide-in_1";
  },200);
}
